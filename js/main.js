$(document).ready(function(){
    ...
    var my_key = "dfdd68db398ce385f652247d59940afe";
    ...
    function w_info(){
        //$("#weather li").remove();  //모든 ㅣㅑ 태그를 제거해라
        ...
        $("#weather li").each(function(index){
            $.ajax({
                url : "https://api.openweathermap.org/data/2.5/weather?q="+ city[index] +"&appid=" + my_key,
                dataType : "json",
                success : function(data){
                    ...
                    console.log(this); //{url: 'https://api.openweathermap.org/data/2.5/weather?q=Busan&appid=1451c23e29ef1202473d5f41f30131c2', type: 'GET', isLocal: false, global: true, processData: true, …}
